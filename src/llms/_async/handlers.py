...
async def handle_openai_generate_text(
    ...
    Args:
        openai_client: The OpenAI async client instance
...
async def handle_anthropic_generate_text(
    ...
    Args:
        anthropic_client: The Anthropic async client instance
